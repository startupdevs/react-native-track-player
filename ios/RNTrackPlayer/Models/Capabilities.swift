...
enum Capability: String {
    ...
    func mapToPlayerCommand(jumpForwardInterval: NSNumber?,
        ...
        case .jumpForward:
            return .skipForward(preferredIntervals: [jumpForwardInterval ?? 15])
        case .jumpBackward:
            return .skipBackward(preferredIntervals: [jumpBackwardInterval ?? 15])
        case .like:
